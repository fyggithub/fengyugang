...
void cal_oclk(void)
{
	...
	iTE_u16	u16T10usInt, u16T10usFlt;
		...
		do{
			...
			iTE_MRx_Msg(("OSCCLK_0=0x%02x, %02x, %02x\n\r",(int)u8RdData[0], (int)u8RdData[1], (int)u8RdData[2]));
 	...
 	iTE_MRx_Msg(("OSCCLK=%d.%dMHz\n\r", (int)(u32OscClk/1000), (int)(u32OscClk%1000)));
	if(FixOCLKD4) {
		u8OscDiv = 4;
	} else if(FixOCLKD5) {
		u8OscDiv = 5;
	...
	iTE_MRx_Msg(("OCLK=%d.%03dMHz\n\r", (int)(u32OscClk/u8OscDiv/1000), (int)((u32OscClk/u8OscDiv)%1000)));
	...
	u16T10usFlt /= 100 ;
     	...
     	iTE_MRx_Msg(("RCLK=%3d.%03dMHz\n\r", (int)(stIt6662->u32RefClk/1000),(int)(stIt6662->u32RefClk%1000)));
     	iTE_MRx_Msg(("T10usInt=0x%03X, T10usFlt=0x%02X\n\r", (int)u16T10usInt, (int)u16T10usFlt));
	...
	if(ucCBusByteNo){
		do{
			...
			for(ucTemp=0; ucTemp<ucCBusByteNo; ucTemp++){
				iTE_MRx_Msg(("CBus Byte[%d] = 0x%X%2X \n\r", (int)ucTemp,(int)(ucCBusData[ucTemp*2]&0x7),(int)ucCBusData[ucTemp*2+1]));

...
iTE_u1 HdmiTx_PostSpenHdcp();
void HdmiTx_SaveKvsHdcp();
...
#define My_HdmiTx_Rb(u8Offset, u8Count, pu8Data)	My_iTE_I2C_ReadBurst(HDMI_TX_ADR, u8Offset, u8Count, pu8Data)
